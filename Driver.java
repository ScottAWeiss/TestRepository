...
public class Driver {
	...
	public static void main(String[] args) {
		...
		SortedArray boston = new SortedArray(10);
        Node temp;
     // Test of the constructor
        Node bill = new Node("Bill", "First Avenue", "345 7474");
        Node mary = new Node("Mary", "Second Avenue", "123 4567");
        Node tom = new Node("Tom", "Third Avenue", "999 9999");
     ...
     // Test of encapsulation. Output Mary’s new Node, then the encapsulated Node
        System.out.println("*** Test of the data encapsulation ***");
        mary.setAddress("Ninth Avenue");  // will not change the data structure Node
